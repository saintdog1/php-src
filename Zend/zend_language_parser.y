...
annotation_values:
		non_empty_annotation_value_list
	|	/* empty */
;

non_empty_annotation_value_list:
		non_empty_annotation_value_list ',' annotation_plain_value { zend_do_add_annotation_value(TSRMLS_C); } 
	|	annotation_plain_value { zend_do_add_annotation_value(TSRMLS_C); } 
;
